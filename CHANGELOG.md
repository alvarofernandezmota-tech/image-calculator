...
- `tests/test_lector.py` — tests para 5 formatos no soportados (`.gif`, `.pdf`, `.svg`, `.txt`, `.mp4`) → `ValueError`
...
### Changed
- README actualizado: sección de tests, tabla de operaciones con ejemplos, estructura completa del proyecto
- ROADMAP actualizado: v0.3 marcada como completada, v0.4 detallada
